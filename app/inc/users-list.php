								...
								<div class="card card-xl-stretch mb-5 mb-xl-8">
									...
									<div class="card-header border-0 pt-5">
										<h3 class="card-title align-items-start flex-column">
											<span class="card-label fw-bolder fs-3 mb-1">Usuarios Cancheros</span>
										</h3>
										<div class="card-toolbar">
											<a href="add-users" class="btn btn-sm btn-light btn-active-primary">
														...
														<tr>
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="d-flex justify-content-start flex-column">
																		<a href="edit-user/<?php echo $user->id ?>" class="text-dark fw-bolder text-hover-primary fs-6"><?php echo $user->name ?></a>
																	</div>
																</div>
															</td>
															<td>
															...
															<td>
																<div class="d-flex justify-content-end flex-shrink-0">
																	<a href="edit-user/<?php echo $user->id ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
																	...
																	<button type="button" class=" mx-1 btn btn-icon btn-bg-light btn-active-color-primary btn-sm btn-change-password" data-user="<?php echo $user->id ?>">
																		<!--begin::Svg Icon | path: icons/duotune/general/gen027.svg-->
																		<span class="svg-icon svg-icon-3">
																			<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
