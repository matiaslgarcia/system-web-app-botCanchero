					...
					<div id="kt_content_container" class="container-xxl">
						...
						<div class="card mb-2">
							<div class="card-body">
								 ...
								 <span class="fw-bolder text-gray-800 text-hover-primary me-3 fs-1">
									Total:
								</span>
								<span class="fw-bolder <?php echo (isset($totalDiario[0]->totalDia) && $totalDiario[0]->totalDia >= 0) ? 'text-success' : 'text-danger'; ?> text-hover-primary me-3 fs-1">
