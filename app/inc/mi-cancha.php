			...
			<main id="contenido" tabindex="-1" class="content d-flex flex-column flex-column-fluid pt-5 pt-0">
				<div class="post d-flex flex-column-fluid" id="kt_post">
					<div id="kt_content_container" class="container-xxl">
						...
						<!-- Item 14 (auditoría UX/UI): antes había acá un cartel aparte avisando
						     que Mercado Pago y las reglas del bot estaban en otra pantalla --
						     "un cartel que explica dónde está algo es la prueba de que está en
						     el lugar equivocado". Reemplazado por una barra de navegación única
						     que se ve igual en las dos pantallas. -->
						<?php $configNavActive = 'establecimiento'; inc('config-nav'); ?>
